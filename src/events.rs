...
//! - `action`: e.g. `init`, `updated`, `pause` (Symbol, <= 9 chars)
...
/// Which mint-family event is being emitted.
///
/// Kept separate from [`Event`] because these events are published inline
/// (without the `v1`/domain prefix) and carry a typed [`MintEventData`]
/// payload rather than the whole [`Event`] enum.
...
impl MintEventType {
    /// The action symbol used as the first event topic.
    pub(crate) fn to_symbol(&self, _e: &Env) -> Symbol {
        match self {
...
/// Data payload serialized by the mint-family events.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
...
pub enum Event {
    ...
    Transfer(Address, Address, u64, i128),
}
...
pub fn publish_event(e: &Env, event: Event) {
    ...
    match event.clone() {
        ...
        Event::AdminUpdated(..) => e
            .events()
            .publish((v1, symbol_short!("admin"), symbol_short!("updated")), event),
        Event::AdminFeeUpdated(..) => e
            .events()
            .publish((v1, symbol_short!("admin"), symbol_short!("fee")), event),
        Event::AdminFeeCleared => e
            .events()
            .publish((v1, symbol_short!("admin"), symbol_short!("fee_clr")), event),
        Event::AdminUpgrade(..) => e
            .events()
            .publish((v1, symbol_short!("admin"), symbol_short!("upgrade")), event),

        Event::BridgeOut(..) => e
            .events()
            .publish((v1, symbol_short!("bridge"), symbol_short!("out")), event),
        Event::BridgeRefund(..) => e
            .events()
            .publish((v1, symbol_short!("bridge"), symbol_short!("refund")), event),
        Event::BridgeInRej(..) => e
            .events()
            .publish((v1, symbol_short!("bridge"), symbol_short!("in_rej")), event),
        Event::BridgeIn(..) => e
            .events()
        ...
        Event::GovCancelled(..) => e
            .events()
            .publish((v1, symbol_short!("gov"), symbol_short!("cancelled")), event),

        Event::WhitelistRoot(..) => e
            .events()
            .publish((v1, symbol_short!("whitelist"), symbol_short!("root")), event),
        Event::WhitelistCleared => e
            .events()
            .publish((v1, symbol_short!("whitelist"), symbol_short!("cleared")), event),
        ...
        Event::StakeUnstake(..) => e
            .events()
            .publish((v1, symbol_short!("stake"), symbol_short!("unstake")), event),
        Event::StakeWithdraw(..) => e
            .events()
            .publish((v1, symbol_short!("stake"), symbol_short!("withdraw")), event),
        Event::StakeConfig(..) => e
            .events()
            .publish((v1, symbol_short!("stake"), symbol_short!("cfg")), event),

        Event::TimelockEnabled(..) => e
            .events()
            .publish((v1, symbol_short!("timelock"), symbol_short!("enabled")), event),
        Event::TimelockSched(..) => e
            .events()
            .publish((v1, symbol_short!("timelock"), symbol_short!("sched")), event),
        Event::TimelockCancel(..) => e
            .events()
            .publish((v1, symbol_short!("timelock"), symbol_short!("cancel")), event),
        Event::TimelockUpgrade(..) => e
            .events()
            .publish((v1, symbol_short!("timelock"), symbol_short!("upgrade")), event),
        Event::TimelockExec(..) => e
            .events()
            .publish((v1, symbol_short!("timelock"), symbol_short!("exec")), event),

        Event::TransferBackfill(..) => e
            .events()
            .publish((v1, symbol_short!("transfer"), symbol_short!("backfill")), event),
        Event::Transfer(..) => e
            .events()
            .publish((v1, symbol_short!("transfer"), symbol_short!("transfer")), event),
    }
}